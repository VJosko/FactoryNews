...
public class MainActivity extends AppCompatActivity {
    ...
    String API_KEY = "6946d0c07a1c4555a4186bfcade76398"; // ### YOUE NEWS API HERE ###
    String NEWS_SOURCE = "bbc-news"; // Other news source code at: https://newsapi.org/sources
    ListView listNews;
    ProgressBar loader;
            ...
            if (xml.length() > 10) { // Just checking if not empty
                ...
                listNews.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    public void onItemClick(AdapterView<?> parent, View view,
                        ...
                        i.putExtra("slikaUrl", dataList.get(+position).get(KEY_URLTOIMAGE));
                        startActivity(i);
                    }
                });
